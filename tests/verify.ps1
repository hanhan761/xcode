...
Assert ($package.version -eq '1.5.0') 'The official two-client release version is incorrect.'
...
Assert ((Get-Content -Raw $nativeOfficeSession) -match "stdio: 'inherit'") 'The office official Codex TUI is not attached directly to the current terminal.'
