...
async function initializeNewThreadForRemoteTui(authority, threadId, {
  ...
  // Its completion is streamed later and can spend time starting MCP servers;
  // the native TUI does not need to wait for that invisible work before it
  // attaches to the accepted rollout.
