...
function createSessionGateway({ sessionId, sessionToken, processId, stateRoot, cwd, getSnapshot, submitRemoteMessage, subscribeOutput, isClosed }) {
    ...
    socket.on('data', (data) => {
      ...
      while (true) {
        ...
        if (!attached) {
          ...
          writeJsonLine(socket, { type: 'attached', sessionId });
          continue;
        }
